...
var _fetchMasterclassesJs = require("./fetchMasterclasses.js");
...
function masterClassDisplayInit() {
    (0, _fetchMasterclassesJs.fetchMasterclasses)().then((data)=>{
...
},{"./fetchMasterclasses.js":"cM6Eu","./swiper.js":"gCYjv","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cM6Eu":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function fetchMasterclasses() {
    try {
        console.log("Parsed JSON data:", (0, _masterclassesJsonDefault.default));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","../data/masterclasses.json":"eiMEy"}],"jnFvT":[function(require,module,exports,__globalThis) {
