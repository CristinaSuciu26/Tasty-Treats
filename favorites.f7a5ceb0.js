...
})({"dmRGk":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "1e2ee72ef7a5ceb0";
"use strict";
...
function renderRecipes(recipes, options = {}) {
    ...
    currentRecipes.forEach((recipe)=>{
        ...
        buttonCard.addEventListener("click", ()=>{
            see(recipe); // pass the recipe data
        });
...
const seeRecipeModal = ()=>{
    ...
    for(let i = 0; i < Math.round(recipe.rating); i++){
        ...
        path1.setAttribute("d", "M12 .587l3.668 7.431 8.2 1.192-5.934 5.782 1.4 8.17L12 18.897l-7.334 3.865 1.4-8.17L.132 9.21l8.2-1.192z");
...
},{}],"943FW":[function() {},{}]},["dmRGk"], null, "parcelRequire78be", {})

//# sourceMappingURL=favorites.f7a5ceb0.js.map
